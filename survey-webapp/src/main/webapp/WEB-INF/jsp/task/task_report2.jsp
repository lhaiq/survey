                ...
                <div class="widget-box transparent">
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar">
                            <div class="widget-toolbar no-border invoice-info">
                                <span class="invoice-info-label">调查人员:</span> <span class="red">小平 </span> <br/> <span
                                    class="invoice-info-label">调研日期:</span> <span
                                    class="blue">2016-08-08</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="user-profile-2" class="user-profile">
                            <div class="tabbable">
                                <ul class="nav nav-tabs padding-18">
                                    <li class="active"><a data-toggle="tab" href="#pictures1"> <i
                                            class="green ace-icon fa fa-picture-o bigger-120"></i> 现场情况
                                    </a></li>

                                    <li><a data-toggle="tab" href="#pictures2"> <i
                                            class="orange ace-icon fa fa-picture-o bigger-120"></i> 门面
                                    </a></li>
                                    ...
                                    <div id="pictures1" class="tab-pane in active">
                                        <div>
                                            <ul class="ace-thumbnails clearfix">
                                                ...
                                                <li><a href="../assets/images/gallery/image-1.jpg" title="Photo Title"
                                                ...
                                                <li><a href="../assets/images/gallery/image-2.jpg" data-rel="colorbox">
                                                ...
                                                <li><a href="../assets/images/gallery/image-3.jpg" data-rel="colorbox">
                                                    <img width="150" height="150" alt="150x150"
                                                ...
                                                <li><a href="../assets/images/gallery/image-6.jpg" data-rel="colorbox">
                                                    <img width="150" height="150" alt="150x150"
                                                         src="../assets/images/gallery/thumb-6.jpg"/>
                                                </a></li>

                                                <li><a href="../assets/images/gallery/image-1.jpg" data-rel="colorbox">
                                                    <img width="150" height="150" alt="150x150"
                                                         src="../assets/images/gallery/thumb-1.jpg"/>
                                                </a></li>
                                    ...
                                    <div id="pictures2" class="tab-pane">
                                        <div>
                                            <ul class="ace-thumbnails clearfix">
                                                ...
                                                <li><a href="../assets/images/gallery/image-4.jpg" data-rel="colorbox">
                                                    <img width="150" height="150" alt="150x150"
                                            ...
                                            <div>
                                                <ul class="ace-thumbnails clearfix">
                                                    <c:forEach items="${entry.value}" var="pic">
                                                        <li><a href="${pic.path}" title="Photo Title"
                                                               data-rel="colorbox"> <img width="150" height="150"
                                                                                         alt="150x150"
                                                                                         src="${pic.path}"/>
                    ...
                    <div class="row">
                        ...
                        <div id="user-profile-3" class="user-profile">
                            <div class="tabbable">
                                <ul class="nav nav-tabs padding-18">
                                    <li class="active"><a data-toggle="tab" href="#template1"> <i
                                            class="green ace-icon fa bigger-120"></i> 客户个人资料
                                    </a></li>

                                    <li><a data-toggle="tab" href="#template2"> <i
                                            class="orange ace-icon fa bigger-120"></i> 客户公司资料
                                    </a></li>
                            ...
                            <div class="profile-users clearfix">
                                ...
                                <div class="profile-users clearfix">
                                    <div class="itemdiv memberdiv">
                                        <div class="inline pos-rel">
                                            <div class="user">
                                                <a href="#"> <img src="../assets/avatars/sound.png"
