    ...
    <form class="login-form" action="/survey/core/user/login" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input name="account" id="username" size="25" class="form-control placeholder-no-fix" type="text"
                       placeholder="用户名"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input name="password" id="password" size="25" class="form-control placeholder-no-fix" type="password"
                       placeholder="密码"/>
            </div>
        </div>
