...
DataSourceTree.prototype.data = function(options, callback) {
	...
	if($data != null)//this setTimeout is only for mimicking some random delay
		setTimeout(function(){callback({ data: $data });} , parseInt(Math.random() * 500) + 100);
...
var tree_data = {
	'for-sale' : {name: 'For Sale', type: 'folder',id:'123'}	,
...
tree_data['for-sale']['additionalParameters'] = {
	'children' : {
		'appliances' : {name: 'Appliances', type: 'item',id:'123'},
